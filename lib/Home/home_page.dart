...
import 'package:mikla_project/pages/Account/account_page.dart';
import 'package:mikla_project/pages/auth/sign_up_page.dart';
import 'package:mikla_project/pages/cart/cart_history.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          currentIndex:
              _selectdIndex, // changing the color in the bottom bar between moving into pages
          onTap: onTapNav,
          items: [
